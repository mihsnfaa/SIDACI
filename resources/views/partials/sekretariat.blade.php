...
<div class="p-6 bg-gray-100 rounded-lg shadow">
    <h2 class="mb-4 text-2xl font-semibold">sekretariat</h2>

    {{-- Upload Form: hanya tampil untuk admin dan user bidang sekretariat --}}
    @if (auth()->user()->level === 'admin' || auth()->user()->bidang === 'sekretariat')
